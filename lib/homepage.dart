...
class HomePageState extends State<HomePage> {
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: _boxes(
                  "https://batis.dz/images/94.jpg",
                  36.73225, 3.08746,"Algiers","Bahi Manel","0526632114"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  ...
                  31.9500, 5.3167,"Ouargla","Benhamadi Yasmine","0785596223"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  ...
                  36.9, 7.76667,"Annaba","Kermiche Asma", "0785491256"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  ...
                  35.55597, 6.17414,"Batna","Bouaziz Amina","0625187559"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  "https://prescriptor.info/images/167.jpg",
                  36.2675, 2.7500,"Medea","Benyahia Wafa", "0689564123"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  ...
                  35.69906, -0.63588,"Oran","Zitouni Aya","0568565422" ),
            ),
          ],
        ),
      ),
  ...
  Widget _boxes(String _image, double lat,double long,String storeName,nameReseller,Phonenumber) {
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: myDetailsContainer1(storeName,nameReseller,Phonenumber),
                    ),
                  ),
  ...
  Widget myDetailsContainer1(String storeName,String nameReseller,String Phonenumber) {
    return Column(
  ...
  Widget _buildGoogleMap(BuildContext context) {
    return Container(
      ...
      child: GoogleMap(
        ...
        initialCameraPosition:  CameraPosition(target: LatLng(36.73225, 3.08746), zoom: 4.5),
        onMapCreated: (GoogleMapController controller) {
          _controller.complete(controller);
        },
        markers: {
          BatnaMarker,MedeaMarker,OranMarker,AlgiersMarker,OuarglaMarker,AnnabaMarker
        },
      ),
    );
  }
